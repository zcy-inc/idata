...
public enum FolderTypeEnum {
    ...
    private static final Map<String, FolderTypeEnum> map = Maps.newHashMap();

    static {
        Arrays.stream(FolderTypeEnum.values())
                .forEach(enumObj -> map.put(enumObj.name(), enumObj));
    }

    public static Optional<FolderTypeEnum> getEnum(String enumName) {
