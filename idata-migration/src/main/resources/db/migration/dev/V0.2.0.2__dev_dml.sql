...
insert into idata.dev_label_define (creator, label_code, label_name, label_tag, label_param_type, subject_type,
label_required, folder_id)
values ('系统管理员', 'assetCatalogue:LABEL', '数据资产', 'ENUM_VALUE_LABEL', 'assetCatalogueEnum:ENUM', 'TABLE', 0, 2);

insert into idata.dev_label_define (creator, label_code, label_name, label_tag, label_param_type, subject_type,
label_required, folder_id)
values ('系统管理员', 'domainId:LABEL', '数据域', 'ENUM_VALUE_LABEL', 'domainIdEnum:ENUM', 'TABLE', 1, 2);

insert into idata.dev_label_define (creator, label_code, label_name, label_tag, label_param_type, subject_type,
label_required, folder_id)
values ('系统管理员', 'metabaseUrl:LABEL', 'Metabase地址', 'STRING_LABEL', 'STRING', 'TABLE', 0, 2);

insert into idata.dev_label_define (creator, label_code, label_name, label_tag, label_param_type, subject_type,
label_required, folder_id)
values ('系统管理员', 'tblDescription:LABEL', '描述', 'STRING_LABEL', 'STRING', 'TABLE', 0, 2);

insert into idata.dev_label_define (creator, label_code, label_name, label_tag, label_param_type, subject_type,
label_required, folder_id)
values ('系统管理员', 'bizProcess:LABEL', '业务过程', 'ENUM_VALUE_LABEL', 'bizProcessEnum:ENUM', 'TABLE', 0, 2);
...
insert into idata.dev_label_define (creator, label_code, label_name, label_tag, label_param_type, subject_type,
label_required, folder_id)
values ('系统管理员', 'columnDescription:LABEL', '描述', 'STRING_LABEL', 'STRING', 'COLUMN', 0, 2);
--
-- dev_enum、dev_enum_value
-- 数据域、业务过程、数仓分层、安全等级、hive字段类型、聚合方式、数据资产
-- 数据域
insert into idata.dev_enum (creator, enum_code, enum_name, folder_id) values ('系统管理员', 'domainIdEnum:ENUM', '数据域', 3);
...
insert into idata.dev_enum (creator, enum_code, enum_name, folder_id) values ('系统管理员', 'bizProcessEnum:ENUM', '业务过程', 3);
...
insert into idata.dev_enum (creator, enum_code, enum_name, folder_id) values ('系统管理员', 'assetCatalogueEnum:ENUM', '数据资产', 3);
--
-- dev_enum_value
-- 同dev_enum
