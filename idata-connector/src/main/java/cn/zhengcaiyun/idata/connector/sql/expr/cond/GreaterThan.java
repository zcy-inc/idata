...
public class GreaterThan extends BaseCondition {
    ...
    private GreaterThan(SqlExpression sqlExpr, String param) {
        super(sqlExpr, param);
    }
    ...
    public static GreaterThan of(SqlExpression sqlExpr, String param) {
        return new GreaterThan(sqlExpr, param);
    }
}
