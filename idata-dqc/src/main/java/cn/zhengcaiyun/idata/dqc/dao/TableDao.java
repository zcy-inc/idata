...
public interface TableDao {
    ...
    List<String> getPwOwners(@Param("database") String database, @Param("tableName") String tableName);

    List<String> getDwOwners(@Param("database") String database, @Param("tableName") String tableName);
