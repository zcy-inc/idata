...
public final class DIJobContentDynamicSqlSupport {
    ...
    public static final SqlColumn<Long> destTableId = DIJobContent.destTableId;
    ...
    public static final SqlColumn<String> srcWriteMode = DIJobContent.srcWriteMode;
    ...
    public static final class DIJobContent extends SqlTable {
        ...
        public final SqlColumn<Long> destTableId = column("dest_table_id", JDBCType.BIGINT);

        public final SqlColumn<String> srcWriteMode = column("src_write_mode", JDBCType.VARCHAR);
