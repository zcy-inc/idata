...
public final class DAGScheduleDynamicSqlSupport {
    ...
    public static final DAGSchedule dag_schedule = new DAGSchedule();
    ...
    public static final SqlColumn<Long> id = dag_schedule.id;
    ...
    public static final SqlColumn<Integer> del = dag_schedule.del;
    ...
    public static final SqlColumn<String> creator = dag_schedule.creator;
    ...
    public static final SqlColumn<Date> createTime = dag_schedule.createTime;
    ...
    public static final SqlColumn<String> editor = dag_schedule.editor;
    ...
    public static final SqlColumn<Date> editTime = dag_schedule.editTime;
    ...
    public static final SqlColumn<Long> dagId = dag_schedule.dagId;
    ...
    public static final SqlColumn<Date> beginTime = dag_schedule.beginTime;
    ...
    public static final SqlColumn<Date> endTime = dag_schedule.endTime;
    ...
    public static final SqlColumn<String> periodRange = dag_schedule.periodRange;
    ...
    public static final SqlColumn<String> triggerMode = dag_schedule.triggerMode;
    ...
    public static final SqlColumn<String> cronExpression = dag_schedule.cronExpression;
