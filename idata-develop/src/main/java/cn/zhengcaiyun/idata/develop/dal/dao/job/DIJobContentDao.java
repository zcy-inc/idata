...
public interface DIJobContentDao {
    ...
    @Results(id="DIJobContentResult", value = {
        ...
        @Result(column="src_tables_fashion", property="srcTablesFashion", jdbcType=JdbcType.VARCHAR),
        ...
        @Result(column="merge_sql", property="mergeSql", jdbcType=JdbcType.LONGVARCHAR),
    ...
    default int insert(DIJobContent record) {
        return MyBatis3Utils.insert(this::insert, record, DI_JOB_CONTENT, c ->
            ...
            .map(srcTablesFashion).toProperty("srcTablesFashion")
    ...
    default int insertSelective(DIJobContent record) {
        return MyBatis3Utils.insert(this::insert, record, DI_JOB_CONTENT, c ->
            ...
            .map(srcTablesFashion).toPropertyWhenPresent("srcTablesFashion", record::getSrcTablesFashion)
    ...
    static UpdateDSL<UpdateModel> updateAllColumns(DIJobContent record, UpdateDSL<UpdateModel> dsl) {
        return dsl.set(del).equalTo(record::getDel)
                ...
                .set(srcTablesFashion).equalTo(record::getSrcTablesFashion)
    ...
    static UpdateDSL<UpdateModel> updateSelectiveColumns(DIJobContent record, UpdateDSL<UpdateModel> dsl) {
        return dsl.set(del).equalToWhenPresent(record::getDel)
                ...
                .set(srcTablesFashion).equalToWhenPresent(record::getSrcTablesFashion)
