...
import static cn.zhengcaiyun.idata.develop.dal.dao.dag.DAGInfoDynamicSqlSupport.*;
...
public interface DAGInfoDao {
    ...
    int insert(InsertStatementProvider<DAGInfo> insertStatement);

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: dev_dag_info")
    @SelectProvider(type=SqlProviderAdapter.class, method="select")
    @ResultMap("DAGInfoResult")
    Optional<DAGInfo> selectOne(SelectStatementProvider selectStatement);

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: dev_dag_info")
    @SelectProvider(type=SqlProviderAdapter.class, method="select")
    @Results(id="DAGInfoResult", value = {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: dev_dag_info")
    default Optional<DAGInfo> selectByPrimaryKey(Long id_) {
        return selectOne(c ->
            c.where(id, isEqualTo(id_))
        );
    }
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: dev_dag_info")
    static UpdateDSL<UpdateModel> updateAllColumns(DAGInfo record, UpdateDSL<UpdateModel> dsl) {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: dev_dag_info")
    static UpdateDSL<UpdateModel> updateSelectiveColumns(DAGInfo record, UpdateDSL<UpdateModel> dsl) {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: dev_dag_info")
    default int updateByPrimaryKey(DAGInfo record) {
        return update(c ->
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", comments="Source Table: dev_dag_info")
    default int updateByPrimaryKeySelective(DAGInfo record) {
        return update(c ->
