...
public interface JobExecuteConfigDao {
    ...
    BasicColumn[] selectList = BasicColumn.columnList(id, del, creator, createTime, editor, editTime, jobId, environment, schDagId, schRerunMode, schTimeOut, schDryRun, execQueue, execMaxParallelism, execWarnLevel, schTimeOutStrategy, schPriority, execDriverMem, execWorkerMem);
