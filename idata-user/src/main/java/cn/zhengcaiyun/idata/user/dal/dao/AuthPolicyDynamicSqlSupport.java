...
public final class AuthPolicyDynamicSqlSupport {
    ...
    public static final AuthPolicy authPolicy = new AuthPolicy();
    ...
    public static final SqlColumn<Long> id = authPolicy.id;
    ...
    public static final SqlColumn<Integer> del = authPolicy.del;
    ...
    public static final SqlColumn<String> creator = authPolicy.creator;
    ...
    public static final SqlColumn<Date> createTime = authPolicy.createTime;
    ...
    public static final SqlColumn<String> editor = authPolicy.editor;
    ...
    public static final SqlColumn<Date> editTime = authPolicy.editTime;
    ...
    public static final SqlColumn<Long> authRecordId = authPolicy.authRecordId;
    ...
    public static final SqlColumn<String> effectType = authPolicy.effectType;
    ...
    public static final SqlColumn<String> actionType = authPolicy.actionType;
    ...
    public static final SqlColumn<String> resourceType = authPolicy.resourceType;
    ...
    public static final SqlColumn<String> remark = authPolicy.remark;
